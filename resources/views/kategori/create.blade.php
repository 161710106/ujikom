...
<nav class="breadcrumb-wrapper" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('kategoris.index')}}">kategoris</a></li>
        <li class="breadcrumb-item"><a href="javascript:void(0)">Tambah kategoris</a></li>
    </ol>
</nav>
@endsection
@section('content')
<div class="col-md-12">
    <div class="card">
        <h5 class="card-header">Tambah kategoris</h5>
