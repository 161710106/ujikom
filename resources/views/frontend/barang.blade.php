...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <div class="hero-area d-flex align-items-center">
        <!-- Hero Thumbnail -->
        <div class="hero-thumbnail equalize bg-img" style="background-image: url(assets/frontend/img/kamera.jpg);"></div>
        ...
        @php
                $barangs = App\Barangg::all();
                $kategoribarangs = App\Kategoribarang::all()
                @endphp
        ...
        <div class="sonar-portfolio-menu">
            <div class="text-center portfolio-menu">
                ...
                @foreach($kategoribarangs as $data)
                        <button class="btn active" data-filter=".barangs{{$data->id}}">{{$data->kategori}}</button>
                        @endforeach
            </div>
        </div>
    </div>
    ...
    <section class="sonar-projects-area" id="projects">
        <div class="container-fluid">
            <div class="row sonar-portfolio">
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_gallery_item barangs{{$data->kategoribarang->id}}" data-wow-delay="300ms">
                <button class="btn">{{ $data->created_at->diffForHumans() }}</button>
                           
                   <!-- Gallery Content -->
                    <div class="gallery-content">
                     
                    <h3><font color="BLACK"><font face="Monotype Corsiva">{{$data->jenis}}</font></font></h3>
