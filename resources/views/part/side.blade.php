    ...
    <div class="sidebar-content">
        <div class="aside-toolbar">
            <ul class="site-logo">
                ...
                <!-- START LOGO -->
                    <a href="/">
                        <div class="logo">
                            <svg id="logo" width="23" height="23" viewBox="0 0 54.03 56.55">
                                <defs>
                        ...
                        <span class="brand-text"style="italic">Hwr Photography</span>
                    </a>
                <!-- END LOGO -->
                </li>
            </ul>
        ...
        <nav class="main-menu">
            <ul class="nav metismenu">
                ...
                @if(Auth::user()->name === 'Admin Larapus')
                <ul>
                    <li>
                            
                        <a href="{{ route('kategoris.index') }}">
                        <i class="icon dripicons-article"></i>Kategori</a>
                    </li>
                    <br>
                    ...
                    <li>
                                    ...
                                    <i class="icon dripicons-article"></i>galeri</a>
                                </li>
                                <br>

                    <li>
                            
                                    <a href="{{ route('fortopolios.index') }}">
                                    <i class="icon dripicons-article"></i>fortopolio</a>
                                </li>
                                <br>
                                <li>
                            
                            <a href="{{ route('harga.index') }}">
                            <i class="icon dripicons-article"></i>Daftar Harga</a>
                        </li> 
                        ...
                        <br>
                            ...
                            <i class="icon dripicons-article"></i>Booking</a>
                        </li>
                        <br>
                        <li>
                            
                            <a href="{{ route('testi.index') }}">
                            <i class="icon dripicons-article"></i>Testimoni</a>
                        </li>
                        <br>
                        <li>
                            
                            <a href="{{ route('kategoribarangs.index') }}">
                            <i class="icon dripicons-article"></i>Kategori Barang</a>
                        </li> 
                        <br>
                        <li>
                            
                            <a href="{{ route('barangs.index') }}">
                            <i class="icon dripicons-article"></i>Barang</a>
                        </li>
                        <br>
                        <li>
                            
                            <a href="{{ route('pinjam.index') }}">
                            <i class="icon dripicons-article"></i>Pinjam Barang</a>
                        </li>
                        <br>
                        ...
                        <li>
                            ...
                            <i class="icon dripicons-article"></i>Pengembalian Barang</a>
                        </li> 
                        @else
                        <li>
                            
                            <a href="{{ route('userr.index') }}">
                            <i class="icon dripicons-article"></i>Peminjam</a>
                        </li>
                        <li>
