...
<nav class="breadcrumb-wrapper" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0)">hargas</a></li>
    </ol>
</nav>
@endsection
@section('content')
<div class="col-12">
     <center>
        <a href="{{ route('harga.create') }}" class="btn btn-primary btn-rounded btn-floating btn-outline">
            Tambah Data
        </a>
    </center><br><br>
    <div class="card">
        ...
        <div class="card-body">
            <table id="bs4-table" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" action="{{ route('harga.destroy',$data->id) }}">
                        <a href="{{ route('harga.edit',$data->id) }}" class="btn btn-warning btn-outline">Edit</a>
