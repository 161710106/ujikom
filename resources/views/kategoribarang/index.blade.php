...
<div class="col-12">
     <center>
        <a href="{{ route('kategoribarangs.create') }}" class="btn btn-primary btn-rounded btn-floating btn-outline">
            Tambah Data
        </a>
    </center><br><br>
    <div class="card">
            ...
            <table id="bs4-table" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('kategoribarangs.edit',$data->id) }}" class="btn btn-warning btn-outline">Edit</a>
