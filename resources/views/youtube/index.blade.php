...
<div class="col-12">
     <center>
        <a href="{{ route('youtube.create') }}" class="btn btn-primary btn-rounded btn-floating btn-outline">
            Tambah Data
        </a>
    </center><br><br>
    <div class="card">
	...
	<tr>
		...
		<td> {{ $data->url }} </td>
                    ...
                    <td>
                        ...
                        <a href="{{ route('youtube.edit',$data->id) }}" class="btn btn-warning btn-outline">Edit</a>
